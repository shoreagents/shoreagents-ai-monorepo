...
export async function POST(request: NextRequest) {
  try {
    ...
    const existingJobAcceptance = await prisma.staff_job_acceptances.findUnique({
    ...
    const jobAcceptance = await prisma.staff_job_acceptances.create({
      data: {
        ...
        hmoIncluded: hmoIncluded !== undefined ? hmoIncluded : false,
