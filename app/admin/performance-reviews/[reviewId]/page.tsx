...
export default function AdminReviewDetailPage({ 
    ...
    return (
      <div className="p-6">
        <Card className="rounded-xl bg-slate-800/50 ring-1 ring-white/10 p-12 text-center">
          ...
          <Button className="mt-4" onClick={() => router.push("/admin/performance-reviews")}>
            Back to Reviews
          </Button>
        </Card>
      </div>
  ...
  return (
    <div className="container mx-auto p-6 max-w-7xl">
      ...
      {error && (
        <Card className="rounded-lg border-red-500 bg-red-50 p-4 dark:bg-red-950 mb-6">
      ...
      <div className="grid gap-6 lg:grid-cols-3">
        ...
        <div className="flex flex-col gap-6 sticky top-6 h-fit">
          ...
          {/* Overall Score */}
          {review.overallScore && (
            <Card className="rounded-lg bg-card border p-6 flex flex-col justify-between">
          ...
          <div className="flex justify-end gap-2">
            ...
            <Button
              onClick={() => {
                ...
                router.push("/admin/performance-reviews")
              }}
            >
              Back to Reviews
            </Button>
