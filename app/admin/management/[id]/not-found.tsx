  ...
  return (
    <div className="flex items-center justify-center min-h-[60vh]">
      <Card className="p-12 border-border bg-card text-center max-w-md">
        ...
        <h2 className="text-2xl font-semibold text-foreground mb-2">Management User Not Found</h2>
        <p className="text-sm text-muted-foreground mb-6">
          The management user you're looking for doesn't exist or has been removed.
        </p>
